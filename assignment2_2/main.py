...
# Add current folder to sys.path for smooth imports
sys.path.append(os.path.abspath(os.path.dirname(__file__)))

from train.training_ddpm import DDPMTrainer

def main():
    parser = argparse.ArgumentParser(description="CLI Training Entrypoint for DDPM/DDIM Framework")
    ...
    print("======= DDPM Training Config Override =======")
